...
public class adminSupplier_list extends javax.swing.JFrame {


    public adminSupplier_list() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Supplier's List");
        ...
        jPanel4.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 240, 30));
        ...
        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 49, 560, 360));
        ...
        jButton9.setText("Restock");
        jButton9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton9ActionPerformed(evt);
            }
        });
        jPanel4.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(431, 420, 140, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminSupplier_list.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminSupplier_list().setVisible(true);
            }
        });
    }
