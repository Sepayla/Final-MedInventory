 ...
 * @author w10
 */
public class adminMedicine extends javax.swing.JFrame {
    ...
    public void medicineList(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT Id, Product_Name, Quantity, Price, Type, Status, Availability FROM medicice_list");
    ...
    private void initComponents() {
        ...
        jPanel8.setBackground(new java.awt.Color(122, 178, 178));
        ...
        jPanel4.add(type, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 10, 270, 30));
        ...
        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 560, 410));
        ...
        jButton1.setBounds(390, 30, 80, 30);
        ...
        jButton2.setBounds(470, 30, 80, 30);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        adminMedicine_edit editMedicine = new adminMedicine_edit();
        ...
        if (rowIndex < 0){
            ...
            try {
                ...
                if (rs.next()){            
                    editMedicine.uid.setText("" + rs.getInt("Id"));
                    editMedicine.productName.setText("" + rs.getString("Product_Name"));
                    editMedicine.quant.setText("" +rs.getInt("Quantity"));
                    editMedicine.price.setText(""+rs.getDouble("Price"));
                    editMedicine.dateManufactured.setText("" +rs.getString("Date_Manufactured"));
                    editMedicine.dateExpiration.setText("" +rs.getString("Date_Expiration"));
                    editMedicine.type.setSelectedItem("" +rs.getString("Type"));
                    editMedicine.status.setSelectedItem("" +rs.getString("status"));
                }
                this.dispose();
            } catch(SQLException ex){
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (rowIndex < 0){
            ...
            TableModel model = medicine_list.getModel();
            ...
            if (a == JOptionPane.YES_OPTION){
                ...
                dbc.deletMedicine(ids, "medicice_table");
                medicineList();
            }
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        adminMedicine_add add = new adminMedicine_add();
        add.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminMedicine.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminMedicine().setVisible(true);
            }
        });
    }
