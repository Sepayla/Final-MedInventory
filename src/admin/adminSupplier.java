...
public class adminSupplier extends javax.swing.JFrame {
    ...
    public void supplierList(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT Id, First_Name, Last_Name, Contact, Email, Company, Availability FROM supplier_list WHERE Availability = '"+ status.getSelectedItem() +"'");
    ...
    private void initComponents() {
        ...
        jPanel9.setBackground(new java.awt.Color(122, 178, 178));
        ...
        jPanel4.add(status, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 10, 270, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        adminSupplier_add addSupplier = new adminSupplier_add ();
        addSupplier.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        adminSupplier_edit editSupplier = new adminSupplier_edit();
        int rowIndex = supplierList.getSelectedRow();
        ...
        if (rowIndex < 0){
            ...
            try {
                DBconnector dbc = new DBconnector();
                TableModel tbl = supplierList.getModel();
                ResultSet rs = dbc.getData("SELECT * FROM supplier_list WHERE Id = '"+ tbl.getValueAt(rowIndex, 0) +"'");
                     
                if (rs.next()){            
                    editSupplier.uid.setText("" + rs.getInt("Id"));
                    editSupplier.fname.setText("" + rs.getString("First_Name"));
                    editSupplier.lname.setText("" +rs.getString("last_Name"));
                    editSupplier.email.setText(""+rs.getString("Email"));
                    editSupplier.gender.setText("" +rs.getString("Gender"));
                    editSupplier.contact.setText("" +rs.getString("Contact"));
                    editSupplier.age.setText("" +rs.getString("Age"));
                    editSupplier.address.setText("" +rs.getString("Address"));
                    //editSupplier.status.setSelectedItem("" +rs.getString("status"));
                }
                this.dispose();
            } catch(SQLException ex){
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (rowIndex < 0){
            ...
            TableModel model = supplierList.getModel();
            ...
            if (a == JOptionPane.YES_OPTION){
                ...
                dbc.deleteSupplier(ids, "users_table");
                supplierList();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
